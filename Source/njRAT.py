...
print(f'Hi {Fore.GREEN}{input("Enter Your Name: ")} {Fore.RESET}You Are From {Fore.GREEN}{input("Enter Your Location: ")} {Fore.RESET}And Your Are {Fore.GREEN}{int(input("Enter Your Age: "))} {Fore.RESET}Years Old\n{Fore.RESET}Bye\n')
